    ...
    <form id="mail-settings-form" class="space-y-6 max-w-4xl">
        ...
        <fieldset class="border-t border-[#374151] pt-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <label class="flex items-center gap-2 text-sm text-[#D1D5DB]"><input type="checkbox" id="mail-auth" name="mail_auth" value="1" <?= $mailConfig['mail_auth'] === '1' ? 'checked' : '' ?>> SMTP authentication</label>
